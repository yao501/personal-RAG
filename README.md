...
- refusal gating now treats unsupported private credential requests, including passwords, API tokens, access tokens, private keys, license keys, activation codes, and serial numbers, as insufficient evidence unless directly cited
- reindex support
